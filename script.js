...
function initSectionAnimations() {
    ...
    (function() {
  emailjs.init("jUlnC9gU_xE6TatVQOqoq"); // ← ضع المفتاح العام من EmailJS
})();

document.getElementById("contact-form").addEventListener("submit", function(e) {
  e.preventDefault();

  emailjs.sendForm("service_ayuxqvn", "template_ps3qk5y", this)
    .then(() => {
      alert("Dn");
    }, (error) => {
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    form.addEventListener('submit', function (e) {
        ...
        emailjs.sendForm(
            "service_ayuxqvn",   // Service ID من EmailJS
            "template_ps3qk5y",  // Template ID من EmailJS
            this
        ).then(
            () => {
